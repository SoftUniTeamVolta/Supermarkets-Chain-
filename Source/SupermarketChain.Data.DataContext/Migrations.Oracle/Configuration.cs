namespace SupermarketChain.Data.DataContext.Migrations.Oracle
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<OracleDataContext>
    {
        ...
        private static void AddSuperMarketsTestData(OracleDataContext context)
        {
        ...
        private static void AddSalesTestData(OracleDataContext context)
        {
            ...
            if (zagorkaVendor != null && kamenitzaVendor != null)
            {
...
";
        ...
        {
            string createSequenceMeasureTable =
...
END;";
            ...
            var products = new List<PRODUCT>
            {
                new PRODUCT
                {
                    VendorId = zagorkaVendor.Id,
                    Name = "Beer \"Zagorka\"",
                    MeasureId = measureL.Id,
                    Price = 1.99m,
                    CreatedOn = new DateTime(2015, 1, 1)
                },
                new PRODUCT
                {
                    VendorId = zagorkaVendor.Id,
                    ...
                    MeasureId = measureL.Id,
                    Price = 1.69m,
                    CreatedOn = new DateTime(2015, 2, 25)
                },
                new PRODUCT
                {
                    VendorId = zagorkaVendor.Id,
                    Name = "Beer \"Starobrno\"",
                    MeasureId = measureML.Id,
                    Price = 2.22m
                },
                new PRODUCT
                {
                    VendorId = kamentzaVendor.Id,
                    Name = "Beer \"Kamenitza\"",
                    MeasureId = measureL.Id,
                    Price = 1.72m
                },
                ...
                new PRODUCT
                {
                    VendorId = bioBulgariaVendor.Id,
                    Name = "\"Whole rye boza\" Harmonica Boza",
                    MeasureId = measureML.Id,
                    Price = 1.42m,
                    PreserveCreatedOn = false
                },
                ...
                new PRODUCT
                {
                    VendorId = mondelezVendor.Id,
                    Name = "Chocolate Milka",
                    MeasureId = measureGR.Id,
                    Price = 2.20m,
                    CreatedOn = new DateTime(2009, 9, 15)
                },
                new PRODUCT
                {
                    VendorId = mondelezVendor.Id,
                    ...
                    MeasureId = measureGR.Id,
                    Price = 7.89m,
                    CreatedOn = new DateTime(2010, 5, 13)
                },
                new PRODUCT
                {
                    VendorId = mondelezVendor.Id,
                ...
                new PRODUCT
                {
                    VendorId = intersnackVendor.Id,
                    Name = "Chio Chips Paprika",
                    MeasureId = measureGR.Id,
                    Price = 3.29m
                },
                ...
                new PRODUCT
                {
                    VendorId = bolyarkaVendor.Id,
                    Name = "Beer \"Kaltenberg Pils\"",
                    MeasureId = measureML.Id,
                    Price = 1.7m
                },
                new PRODUCT
                {
                    VendorId = bolyarkaVendor.Id,
                    Name = "Beer \"Bolyarka Lager\"",
                    MeasureId = measureML.Id,
                    Price = 1.18m
                },
                new PRODUCT
                {
                    VendorId = detelinaVendor.Id,
                    Name = "Row Nuts Mix",
                    MeasureId = measureGR.Id,
                    Price = 4.98m
                },
                ...
                new PRODUCT
                {
                    VendorId = sunMoonVendor.Id,
                    Name = "Bread with Olives and dried Tomatoes",
                    MeasureId = measureP.Id,
                    Price = 5.12m
                },
                new PRODUCT
                {
                    VendorId = sunMoonVendor.Id,
                    Name = "Zayo-Bayo with Butter",
                    MeasureId = measureP.Id,
                    Price = 0.30m
                },
                new PRODUCT
                {
                    VendorId = sunMoonVendor.Id,
                    Name = "Zayo-Bayo with Cream and Onio",
                    MeasureId = measureP.Id,
                    Price = 0.35m
                },
                new PRODUCT
